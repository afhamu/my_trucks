...
public class AddIncomeFragment extends Fragment {
    ...
    private TextInputLayout editText_goods;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editText_goods = view.findViewById(R.id.goods);
        ...
        btnAddIncome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String goods = editText_goods.getEditText().getText().toString();
                String description = editText_description.getEditText().getText().toString();
                addIncome(date, truck, category, description, goods, amount);
            }
        });

    }

    public void addIncome(String date, String truck, String category, String description, String goods, String amount){
        progressDialog.setMessage("Adding...");
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_ADD_INCOME, response -> {
            progressDialog.dismiss();
            navController.navigate(R.id.action_addIncomeFragment_to_mainFragment);
        },
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("income_type", category);
    ...
    public void getIncomeCategory(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_GET_INCOME_CATEGORIES, response -> {
            try {
                JSONArray array = new JSONArray(response);
                for (int i = 0; i< array.length(); i++){
                    JSONObject object = array.getJSONObject(i);
